...
Food Lens — интеллектуальный Telegram-бот для анализа питания по фотографиям. Бот использует AI для определения пищевой ценности блюд и описания рецепта блюда с фото.
